...
PRAZO DO CONTRATO: Enquanto durar a mensalidade ou contratação de qualquer produto da PAGUE SAFE.
...
3.1. A inclusão do cliente à PAGUE SAFE está condicionada à aceitação prévia do Cliente pela CONTRATADA, conforme critérios de interesse comercial, estando sujeita a verificação prévia de inexistência de irregularidade na identificação e/ou nos dados cadastrais do cliente, de seu representante legal e/ou procurador, bem como normas internas de KYC (Know Your Customer), cabendo ao cliente encaminhar toda a documentação e informações exigidas pela PAGUE SAFE, no prazo máximo de 15 (quinze) dias, a contar da solicitação.

3.2. Ao clicar na opção “LI e ACEITO os termos do contrato”, o CONTRATANTE declara ter lido, compreendido e aceito, sem reservas, todas as cláusulas e condições do presente Contrato, a Política de Segurança, Privacidade e Direitos Autorais da PAGUE SAFE.
...
4.2. A cessão da licença(s) de uso do software denominado “PAGUE SAFE”, de titularidade da CONTRATADA, será temporária e não exclusiva.
...
4.5. O software “PAGUE SAFE” é capaz de processar transações eletrônicas de pagamento, desde que possibilitados pelas adquirentes ou subadquirentes contratadas pelo Cliente, através dos seguintes meios:
Via bancária;
Boleto bancário;
Cartão de Crédito;
PIX.
...
4.5.3. O ESTABELECIMENTO RECONHECE E SE DECLARA DE ACORDO QUE, POR MEIO DO PIX CHECKOUT, A PAGUE SAFE ATUARÁ COMO AGENTE DE COLETA DOS PAGAMENTOS EFETUADOS PELOS CLIENTES. A PAGUE SAFE SERÁ O USUÁRIO FINAL RECEBEDOR DOS VALORES TRANSACIONADOS VIA PIX, OBRIGANDO-SE A REALIZAR O REPASSE DAS QUANTIAS DEVIDAS AO ESTABELECIMENTO, DEDUZIDAS AS TARIFAS E ENCARGOS APLICÁVEIS, Fluxo de pagamento. O fluxo de pagamento para realização de transações via pix e recebimento do repasse pelo Estabelecimentos ocorre da seguinte maneira: após a habilitação do pix checkout, o cliente poderá solicitar opção de pagamento via Pix na Plataforma do Parceiro; por meio da integração com os sistemas PAGUE SAFE, o Parceiro solicitará a PAGUE SAFE geração de ação do pagamento via Pix, fornecendo os dados necessários conforme solicitados pela PAGUE SAFE.

4.6. O programa “PAGUE SAFE” permanecerá instalado no data center da CONTRATADA e o CONTRATANTE terá acesso ao mesmo via internet, sendo-lhe disponibilizadas as licenças nos termos contratados.

4.7. O CONTRATANTE não terá direito a eventuais novas funcionalidades acrescidas ao programa “PAGUE SAFE”, hipótese em que, caso pretenda novos serviços oferecidos pela CONTRATADA, deverá efetuar nova contratação. O CONTRATANTE somente terá direito ao aperfeiçoamento das funcionalidades já existentes no programa cuja licença é contratada neste ato.

4.8. O CONTRATANTE declara possuir ciência de que a PAGUE SAFE oferece uma estrutura de subadquirência White Label Product, que não integrará o Sistema de Pagamentos Brasileiro (SPB), desde que, nos termos da Resolução BACEN nº 150 de 06 de outubro de 2012, e o conjunto de participantes apresente, de forma consolidada e acumulada nos últimos 12 (doze) meses, volumes inferiores a:
...
9.2. Informar ao CONTRATANTE, com 3 (três) dias de antecedência, sobre eventuais interrupções necessárias para os ajustes técnicos ou manutenção que demandem mais de 6 (seis) horas de duração e que possam causar prejuízo à operacionalidade da licença fornecida, salvo em caso de urgência.

9.2.1. Nos casos de urgência, assim entendidos aqueles que coloquem em risco o regular funcionamento do servidor onde está o software “PAGUE SAFE” e aqueles determinados por motivo de segurança decorrentes de vulnerabilidades detectadas, as interrupções ocorrerão sem prévio-aviso e não deverão superar a duração de 2 (duas) horas cada.

9.2.2. As manutenções e interrupções a serem informadas são única e exclusivamente aquelas que interfiram com a operacionalidade da “PAGUE SAFE”, ficando dispensadas informações prévias sobre interrupções, por motivos técnicos, de licenças adicionais que não impliquem em prejuízo para a operacionalidade da utilização das licenças da CONTRATADA.

9.3. A interrupção que interfira ou que cause prejuízo à operacionalidade da licença e seja necessária para a manutenção do sistema será realizada, num período não superior a 6 (seis) horas, preferencialmente, entre as 00h00 e as 6h00hs.

9.4. As interrupções para a manutenção no fornecimento das licenças adicionais que não impliquem em prejuízo para a operacionalidade do servidor, perdurarão pelo tempo necessário à supressão das irregularidades detectadas, não devendo superar o prazo de 60 (sessenta) dias corridos.

9.5. Manter o sistema disponível para a utilização por, pelo menos, 97% (noventa e sete por cento) do tempo a cada mês.

9.6. Disponibilizar, por meio do site https://www.paguesafe.com, as instruções que possibilitem que o programa de pagamento e licenças sejam utilizados corretamente pela CONTRATANTE.

9.7. Garantir o sigilo dos dados trafegados através da PAGUE SAFE, dentro dos padrões de mercado para operações comerciais deste tipo. Sem prejuízo ao disposto acima, a CONTRATADA poderá divulgar todos e quaisquer dados trafegados através da PAGUE SAFE caso tal divulgação se dê nos termos da Cláusula 13, abaixo.
...
10.6. Manter sistemas operantes e atualizados que consigam fazer a interface com a PAGUE SAFE, durante toda a vigência deste Contrato.
...
9.11. Responder, com exclusividade, pelos atos praticados por seus prepostos, administradores e/ou por toda e qualquer pessoa que venha a ter acesso ao código de acesso à PAGUE SAFE, declarando-se ciente de que a responsabilidade pelos atos praticados será, sempre, única e exclusiva da CONTRATANTE.
...
11.4. Entende-se por garantia de desempenho para efeitos do presente Contrato a acessibilidade pela CONTRATANTE aos programas licenciados (PAGUE SAFE) e disponibilizados nos servidores da CONTRATADA, motivo pelo qual não serão computados, para efeito de apuração do SLA:
...
Falha nos serviços de telecomunicações dos quais a CONTRATANTE se valerá para utilizar os programas ora licenciados.
Falhas de configuração, de responsabilidade da CONTRATANTE, ou sobrecarga do servidor causada por configuração ou utilização inapropriada.
...
Falhas ocasionadas por incompatibilidade entre os programas ora licenciados e eventuais outros programas ou equipamentos utilizados pela CONTRATANTE.
Interrupções ou suspensões dos serviços objeto do Contrato que individualmente perdurem por menos de 24 (vinte e quatro) horas.
